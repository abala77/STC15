...
#define SW_NTC	   P13			//温度检测开关
#define SW_NTC_ON	 (bit)1
#define SW_NTC_OFF (bit)0
...
static void NTC_Switch_ON(void);					//温度检测开
static void NTC_Switch_OFF(void);					//温度检测关
