...
static void Display_TwoNum(uint8_t );//显示两位数字
...
*/
/*--------------未开放函数-------------------------
static void Display_TwoNum(uint8_t Data)
{
	TM1620.Disp_Number(1,(uint8_t)Data/10);
	TM1620.Disp_Number(2,(uint8_t)Data%10); 
}
*/
